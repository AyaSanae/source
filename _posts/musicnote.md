...
![二部曲式](/assets/musicnote/ebqs1.png)
...
下图是一部海顿早期键盘奏鸣曲中的小步舞曲,我们在每一部分的结尾处都标记了终止形式.注意这个例子是二次反复结构,第一部分结束于属和弦(第8小节),而当所有第一部分再现时(第17-24小节),终止便作了调整以便形成最后的主和弦结束.因此这个小步舞曲是一个二次反复延续三部曲式的例子.
![三部曲式](/assets/musicnote/sbqs.png)
![三部曲式](/assets/musicnote/sbqs1.png)
在较短小的三部曲式中,B部分常常明显基于A部分的材料.这一点在上图的B部分也都有体现,特别表现在前几小节中.

下图是一个三声中部(trio),它延续了从上图开始的乐章.同样这又是一个二次反复结构,但这里的A部分结束于三声中部的主调e小调的正格终止.
B部分(第11-19小节)是基于A部分的材料,但某些音型做了逆转(对比1-2小节与11-12小节),而且是在关系大调上.第20小节A的再现对听者来说相当明显,虽然这次A部分比呈示部分稍长了一点,而且做了很多变化,甚至包括了一些B部分的逆转音型.曲式为二次反复分解三部曲式.
![三部曲式](/assets/musicnote/sbqs2.png)
![三部曲式](/assets/musicnote/sbqs3.png)
与大部分小步舞曲与三声部的组合一样,海顿的小步舞曲也分别在三声部的之前与之后演奏,所以整个乐章本身也是一个分节的三部曲式.

下图看上去好像是一个五部分的曲式,如下方结构图
![曲式结构](/assets/musicnote/dbqs.png)
![曲式结构](/assets/musicnote/dbqs1.png)
![曲式结构](/assets/musicnote/qsfx.png)
但是仔细分析后会发现,舒曼只是将二次反复延续为三部曲式的第二次反复再写了一次
![曲式结构](/assets/musicnote/qsfx1.png)

大量20世纪流行歌曲,特别是在摇滚乐产生之前创作的歌曲,大部分都是用分解三部形式,我们将其称为美国流行民谣曲式.
它包括一个8小节的乐段,然后重复并唱不同的歌词,之后是一个8小节的桥,通常在另一个调上,最后返回到开始的乐段.这种形式可以用下面结构概括:
![流行曲式](/assets/musicnote/lxqs.png)

### 再现二部曲式
很多时候,表现为三部曲式的最后一个部分只再现第一个A部分的一半:A B 1/2A.
很多理论家称这种曲式为再现二部曲式.分节再现二部曲式的乐句结构通常可以用下图表示:
![再现二部曲式](/assets/musicnote/zxebqs.png)
这是许多传统曲调的曲式结构,如下图例:
![再现二部曲式](/assets/musicnote/zxebqse.png)

下图是一个变奏曲的主题,这是一个二次反复分节再现二部曲式的例子.与上例唯一不同的是a'乐句再现时有两小节扩充.
![再现二部曲式](/assets/musicnote/zxebqse1.png)

### 十二小节布鲁斯
12小节布鲁斯是爵士乐,摇滚乐,和相似风格音乐的一种重要的曲式结构.
它由4小节乐句组成,又是用aab模式,有时用abc模式.如果是一首带歌词的布鲁斯,歌词往往也是aab或abc.
12小节布鲁斯最基本的和声模式如下图:
![十二小节布鲁斯](/assets/musicnote/tbls.png)
虽然这个模式在布鲁斯总是可以感受到,但其实还有许多变化,而且严格按照这种简单模式的布鲁斯如今已经很少了.
在下图例子中.只有第二个乐句采用了这个模式.第一个乐句用增属和弦装饰,并且结束在一个V7/IV上平滑地导入第二个乐句.最后一个乐句用了V7和IV9代替了三和弦,而结束用了I-IV7-I.同样,注意大小调式的混合(通过使用G,Gb和F#)这种典型布鲁斯特征.
![十二小节布鲁斯](/assets/musicnote/tblse.png)

### 其他三部性曲式
二部曲式和三部曲式,特别是后者,是许多独立作品和多乐章作品单独乐章的基本结构.典型的小步舞曲与三声中部是分解三部曲式,因为小步舞曲分别在三声中部的前面和后面演奏.
![其他三部性曲式](/assets/musicnote/osqs.png)
小步舞曲本身通常也是一个二次反复三部曲式或二次反复再现二部曲式,三声中部也是如此.

慢板乐章也经常为三部曲式,勃拉姆斯的《第一交响曲》第二乐章是一个很好的例子.这个乐章还用了连接部--起到连接不同主题或调性中心作用的片段,以及尾声(Coda)--特殊的结束部.
![其他三部性曲式](/assets/musicnote/osqs1.png)

### 奏鸣曲式
奏鸣曲式(或奏鸣-快板曲式)经常用于奏鸣曲,弦乐四重奏,交响乐或相似作品的第一乐章,虽然其他乐章也可能用奏鸣曲式.
早期奏鸣曲式的例子很像二次反复延续三部曲式.但是,它的三个部分是被极大地扩充了的,包括被连接或展开性材料串联的主题或主题组.
虽然每一个奏鸣曲式构建的乐章都是以其独特的方式展示其材料的,但还是可以给出基本曲式结构图:
![奏鸣曲式](/assets/musicnote/zmqs.png)
有关上图的几点简要说明:
1.取代ABA表述,我们用呈示部,展开部,再现部来表示奏鸣曲式这三大部分.这些名称可以高速我们关于每一部分主题和调性功能的一些事情.
a.呈示部:用以呈现那些重要的主题以及乐章中两个最重要调性之间的冲突.
b.展开部:含有更富于变化的组织结构--可以发展呈示部主题的动机,可以通过模进形成运动形态,或(偶尔)可以引入新的主题.它也发展调性对比,在准备回到主调之前涉及若干各调,常常为远关系调.
c.再现部:重新回到乐章的那些重要主题,一般用相同的顺序,但向副调的转调却要有变化.换句话说,在呈示部中副调上的主题要回到主调上来,由此解决了在呈示部建立起来的调性冲突.

上图图表中的罗马数字并不是单独的和弦.相反,他们代表每个部分的调,并展示了这些调与乐章主调之间的关系.对大多数奏鸣曲式来说,如果主调为大调,最重要的副调是V即属调.如果主调为小调,最典型的副调是III,即关系大调.

上图P和S分别代表了主部主题(P主题,主要主题,第一主题)和副部主题(S主题,次要主题,第二主题)组.这些主题组出现在呈示部和再现部中,被许多不稳定的作为连接的音乐片段分割开.每个主题组可以包括一个或多个主题,他们的结构通常为乐段,句子或二部/三部曲式.注意,在呈示部中这两个领域一定是在在不同的调上呈现的,但再现部他们却都出现了在主调上.像呈示部,展开部,再现部所体现的功能一样,这些主题组也有他们自己独立的功能特征.
a.主部主题: 至少要在主调上使用一次(通常是PAC或HC)以建立主调.他们的音响与副部主题相比通常是充满活力的,华丽的,或郑重的,虽然也可以见到抒情性的主部主题.
b.连接部: 在P和S之间的音乐片段,典型地通过连续动荡的音乐材料以及主调或副调的半终止来动摇主调.连接部可以转调也可以不转调.转调的连接部(以及一些不转调的连接部)在再现部中最典型的就是重新写作,以使其称为为不转调.
c.副部主题:在呈示部中通过副调的PAC建立副调以形成调性冲突.在再现部中,副部主题在动荡的连接部之后用相同的方法回归到主调.副部主题通常具有抒情或优雅的性格.
d.呈示部和再现部的结尾常常带有一个结束部,它以简单的模进和终止模式强调了主要的调性.

十九世纪音乐中反复比18世纪少得多但却更多地使用长大的引子和尾声(Coda).在更晚写的音乐中,呈现在两个调领域中的主题数量也有越来越多的趋势.

### 回旋曲式
回旋曲式是由一个反复出现的叠部主题中间插入若干对比性材料所形成的曲式结构.结构的再现原则使回旋曲式和与三部曲式包括奏鸣曲式具有相同属性,但更多次的再次出现又成为回旋曲式的独特个性.
回旋曲式经常可以在奏鸣曲,弦乐四重奏,交响曲的末乐章找到,甚至有时也用于慢板乐章。

回旋曲式最常用的有四种类型:
![回旋曲式](/assets/musicnote/hxqs.png)
上表的x表示既不是I也不是V的其他调,(?)表示有多重可能性.回旋曲式的主调如果使用小调,常常用关系大调III代替V.

下图是一个典型的五部回旋曲式,其中A部分是一个延续二部曲式的主题.B和C部分分别转到vi和IV,最后A的再现被及大地扩充了,其功能好像是一个长大的尾声(Coda)（各种类型回旋曲式的典型特征)
![回旋曲式](/assets/musicnote/hxqse.png)
![回旋曲式](/assets/musicnote/hxqse1.png)
![回旋曲式](/assets/musicnote/hxqse2.png)
![回旋曲式](/assets/musicnote/hxqse3.png)
![回旋曲式](/assets/musicnote/hxqse4.png)
![回旋曲式](/assets/musicnote/hxqse5.png)
![回旋曲式](/assets/musicnote/hxqse6.png)

回旋曲式与七部回旋曲式不同,因为它的C部分是前面的材料展开.此外,任何一种回旋曲式的B部分可能体现为奏鸣曲式的呈示部的连接部分和副部主题的功能--转调到副调,然后通过清晰的主题陈述建立这个调.当这种方式应用于回旋奏鸣曲式时,就好像是一个带有两次主部主题(A)"附加"在现的奏鸣曲--一次在呈示部后面,另一次在再现部后面.

## 调式交替
调式交替是指在某一调式中(此处的"调式"概念仅指大调式和小调式)使用另一调式的特性音级.
较常见的调式交替是在大调中为增加和声色彩使用其同主音小调的音.调式交替和弦是变化和弦重要来源之一,使用它们常常是为了音乐表现目的.称调式交替和弦为借用和弦或变音和弦.

### 小调的借用和弦
有些理论家认为小调中,升高6和7也是调式交替.如果按照这样的观点,那么各种小调的V也就变成了从大调借来的和弦了,这样的话小调的调式交替就会相当普遍.
我们的观点是,音级6和7是小调的另外两种音阶形式,这就是说,只有升高的3才是小调唯一的借用音.

在小调音乐中,借自大调的含有升高3的和弦主要是大主三和弦.主三和弦升高的3叫做辟卡迪三度(Picardy third),他作为大多数小调作品的结束和弦.
下图例中的大写的罗马数字I就可以表示调式交替了,因此不用在分析中加入特殊符号来表示调式交替.
![调式交替](/assets/musicnote/dsjte.png)

### 大调降VI级音的应用
在大调中最常见的调式交替的例子是在和弦中使用b6.b6是指音阶的第VI级音被降低.
在音乐作品中,由于不同的调号,b6所使用的变音几号可能包括:还原号,降号和重降号.
大调从同主音小调借用的b6可能构成最常用的四个借用和弦:vii°7,ii°,ii半减七,和iv.下图是A大调上的这四个和弦,请注意这些罗马数字标记和小调上是一样的.
![借用和弦](/assets/musicnote/ajyhx.png)
vii°7事实上比vii半减七用的更加普遍,因为在到达和解决时它不会带来平行五度的问题.

vii°7和弦是下图主要动机因素之一,每一次都以强音出现.虽然b6即Fb在内声部,但是它却是从第一个乐句开始,到第二个乐句结束的一个重要旋律线条的开端:Fb-Eb-Db|Fb-Eb-Db-C.同样注意第15小节由非正常的V-ii-V进行构成的很有趣的效果. 
![调式交替](/assets/musicnote/dsjte1.png)
我们知道,vii°7/ 或vii半减七/ 都可以成为大三和弦的副导和弦.那么我们就应该明白某个大三和弦的vii°7的使用也是调式交替的结果.上图的vii°7/V就是这个和弦的例子,其中Cb是从eb小调借过来的.

通常Vii°7并不是直接解决到I而是先进行到V7.此时只需要移动一个声部就可以了.如下图:
![vii°7的解决](/assets/musicnote/sbjx.png)

借用和弦iv通常使用第一转位,使b6称为下行级进低音线的一部分.如下图:
第4到第5小节高音部与次中音部相仿.
![调式交替](/assets/musicnote/jiv.png)

借用和弦ii半减七可能比借用和弦ii°用得更多一点,因为七音可以带来更多的倾向性.
![调式交替](/assets/musicnote/bjqii.png)
一般情况下,vii°7,iv或ii°(半减七)中的b6下行半音到5.它的到达一般也用级进,从还原6或从5.

### 大调的其他借用和弦
大调中最常见的调式交替就是"借用"b6的和弦:ii°,vii半减七,iv和vii°7.
另一些比较常见的调式交替和弦是由b3形成的:i,bVI和iv7,较少见的调式交替和弦使用b7:bIII和bVII.
下图展示了所有上面提到的和弦,注意借用的下中三和弦,中音三和弦,下主音三和弦,都是将降号放在和弦标记前面,以表示这些和弦根音被降低.
![调式交替](/assets/musicnote/dddsjt.png)

在大调音乐中vii°7,iv和ii°(半减七)经常可以单独使用,而在一段较长的平行小调片段中也会经常用到的小主三和弦.
下图第31小节开始变为小调式,而大调知道36小节D的出现才得以重新建立.注意,由于Bb是贯穿全部音乐的调性中心,因此这并不是转调.
这个例子还展示了通过其副属和弦到达的bVI的进行.bVI有时被用来在阻碍终止中构成戏剧性效果.V+56/IV是一个增属和弦,后面将进行讨论.
![调式交替](/assets/musicnote/dsjtee.png)
![调式交替](/assets/musicnote/dsjtee1.png)

bVII和bIII和弦极少见到.当bVII出现时,其功能往往体现为V/bIII,正如在同主音小调中同一个和弦的用法.
在下图中,bIII的前面就用了它的副属和弦,其后面接以借用和弦vii°7.第26小节到27小节的低音部C和C#是经过音,将V7与V56连接起来.这类和弦不需要罗马数字标记.
![调式交替](/assets/musicnote/sdsjt.png)
![调式交替](/assets/musicnote/sdsjt1.png)

### 利用调式交替和弦转调
在新调中的调式交替和弦常常被用来作为一个信号,使得听者感受到转调的发生.在下图,有一个f到Eb的转调.在第5小节贝多芬用了一个f小三和弦,它是连接两个调的共同和弦.接下来的f半减七向听者传递了转调的信息,因为这是一个在f小调中不可能出现的和弦.(Ger+6将在后面讨论)
![调式交替转调](/assets/musicnote/dsjtzd.png)
![调式交替转调](/assets/musicnote/dsjtzd1.png)

调式交替可以简化某些远关系调的转调.如果一段大调音乐平顺地进入其同主音小调,所有该同主音小调的近关系调就都容易到达了.
例如,下图展示了F大调通过调式交替与其他调性的联系:
![调式交替转调](/assets/musicnote/dsjtzd3.png)
下图是例子:F->(f)->Ab
![调式交替转调](/assets/musicnote/dsjtzde.png)


## 那波里和弦
虽然I-V-I是调性和声中构成和声结构力的最基本进行,但是作为属和弦"前景"的诸多和弦,却在音乐进行中为属和弦的进入提供了丰富的和声音响.
可以用在属和弦之前的非常富于色彩的和弦之一是那波里和弦.

那波里和弦的缩写是N(有时也会用标记:bII).
简言之,那波里和弦是建立在降低音阶II级音上的大三和弦.在小调他需要一个变音记号,在大调则需要两个变音记号.
如下图:
![那波里和弦](/assets/musicnote/nc.png)

### 那波里和弦的常规用法
那波里和弦通常采用小调并采用第一转位形式.事实上,由于第一转位已经成为典型用法,那波里和弦常常被称作那波里六和弦.
它具有属前功能,最终进行到V,很像自然和弦ii(或ii6),但听觉效果却显著不同.
下图展示了N6若干种常见前后关系:
![那波里和弦](/assets/musicnote/nce.png)
上图展示出了N6的几个主要特征:
1.如果要重复音,通常重复N6的三音.
2.N6应进行到V(或i46-V),而vii°7/V可以出现在N6和V之间.iv或ii°一般不能跟在N6的后面.
3.b2(N6的根音)应下行进行,特别是当它出现在旋律声部时.他的进行目标是导音--以非常规的减三度音程出现在b2下面(如上图a,b中的高音部线条).若N6先进行到i46或vii°7/V,这个减三度可以用主音加以填充(如上图c和d)
4.当N6进行到i46时,如上图c,可以用平行四度来避免平行五度.如果将上图c中的中音部降低八度将会出现平行五度.
5.N6的前面,像没有变化的ii°6一样,通常用VI,iv或i.

下图是N6的三声部织体.为了到达i46的三音,次中音部有一个从A3到E4的大跳.
![那波里和弦](/assets/musicnote/ncs.png)
![那波里和弦](/assets/musicnote/ncs1.png)
![那波里和弦](/assets/musicnote/ncs2.png)

下图,作者在大调中用了那波里和弦(并且用了原位和弦),他从前两小节就开始使用了调式交替和弦来为N的出现做好了准备
![那波里和弦](/assets/musicnote/ncs3.png)

下图从A大调开始结束语ab小调(虽然两个调号都与分析的不同).双纵线前面的I6和弦等音等于Bbb大三和弦,他是ab小调的那波里和弦.之后,这个和弦自然地进行到ab小调的i46-V
![那波里和弦](/assets/musicnote/ncs4.png)

下图的第108小节的和弦包含那波里和弦的所有音,但是他并没有进行到V.正如织体简缩谱展示的,N6成为两个i6之间的邻音和弦.
![那波里和弦](/assets/musicnote/ncs5.png)

下图有一个非常规的n6小那波里和弦,而且舒伯特还特意用本乐章中最后一个强记号(forte)来强调这个和弦.n6后面接Ger+6.有趣的是Ger+6与V7/n6为等和弦.
![那波里和弦](/assets/musicnote/ncs6.png)

下图的V7前面用了一个N7(大小七和弦),构成了一个相互间为三全音的两个大小七和弦连续.这是三种相互间有两个共同音的=大小七和弦的一种,此处的两个共同音是D和Ab/G#.注意对这个非常规的那波里和弦力度上的强调,与前面的例子是一样的.
![那波里和弦](/assets/musicnote/ncs7.png)

## 增六和弦
### 增六度音程
强调一个音的方法之一,是以半音到达这个音,包括从上方或下方.
在下图例a和b中g小调的属音都是以半音到达.如果同时从上方和下方到达属音,则可以形成对属音更强烈的支持,如下图c.
![增六度音程](/assets/musicnote/zldyc.png)
我们可以注意到,c中两个准备到达属音的音,纵向上形成了一个增六度音程.
到达属音的这种方法产生了属前和弦的一个种类,叫增六和弦.

上图c显示出大多数增六和弦的基本特征:
1.要达到的和弦是V和弦
2.小调的6(如果在大调则要半音降低6)出现在低音部.
3.#4出现在上方的某个声部.

由这些音构成的增六度音程与小七度音程为等音程,但听觉上容易分辨出这两种音程在效果上的差异.
下图a是小七度的解决倾向,下图b是增六度的解决倾向.
![增六度音程](/assets/musicnote/zldyc1.png)
在二声部织体中,增六和弦以上图b的形态出现.分析标记只需要用+6就可以了.注意是阿拉伯数字,不是罗马数字(+VI).

增六度音程常常遵循两个音的自然倾向半音向外解决而导向属音.
较少数情况下,增六度音程上方音可以半音下行构成V7的七音.这种情况一般只能出现在增六和弦由三个或以上音构成,且增六度音程的上方音要在内声部.

由于上方提到的原因,增六和弦成为所有属前和弦中最强的一类和弦,而且它通常直接进行到V或i46-V.
增六和弦常常紧接着转调以后使用,以使得听觉上更清晰感觉到转调的发生.
像N6一样,增六和弦最早也被应用于小调.当它应用于大调中时,其前面常常可以用调式交替和弦.

### 意大利增六和弦
在大多数情况下,增六和弦都包含不止两个音.
如果出现第三个和弦音,它通常是调式主音,即低音上方的大三度音.这样构成的和弦叫意大利增六和弦(It+6),如下图:
![意大利增六度](/assets/musicnote/it.png)

像其他增六和弦一样,It+6解决于V或I46-V,在四声部织体中重复主音.
下图是一个典型用例:
![意大利增六度](/assets/musicnote/it1.png)

下图是三声部织体中It+6的应用.音乐片段大部分都是有平行六度中包含着一个主持续音组成,注意低音部四次到达5,但每次都用了不同的和声.
![意大利增六度](/assets/musicnote/it3.png)

### 法国增六和弦
还有两个常用的包含有四个音的增六和弦,这两个和弦都可以被认为是在意大利增六和弦的基础上再加上另外一个音构成.
如果增加的音是2,这个和弦就被称作法国增六和弦(Fr+6)如下图:
![法国增六度](/assets/musicnote/fr.png)
Fr+6在四声部和自由织体中更容易应用,下图是一个典型例子:
![法国增六度](/assets/musicnote/fr1.png)

在下图中,Fr+6所产生的和声色彩构成了整个乐章的高潮.在第38小节的点上,贝多芬采用了七声部织体,这也是为什么#4被重复的原因.
在接下来的小节中,音乐突然回到弱奏而且织体也变"薄"了,以至于解决音(5)仅出现在低音部.
注意,低音部和次中音部始终都以平行三度进行.
![法国增六度](/assets/musicnote/fr2.png)
Fr+6和弦偶尔也会出现在流行和爵士中,他的标记用Mm7和弦加上一个降五音如下图标记:
![法国增六度](/assets/musicnote/fr3.png)

### 德国增六和弦
另一个常用的包含四个音的增六和弦是德国增六和弦(Ger+6).他可以被认为是在意大利增六和弦上加上一个小调的3(大调则要半音降低3).
![德国增六和弦](/assets/musicnote/ger.png)
同其他增六和弦一样,Ger+6解决于V和i46-V.
如果Ger+6直接解决到V,将会出现两声部间的平行五度.
如下图,由于人的听觉主要被增六度音程解决所吸引,平行五度在这里也不是完全被禁止,偶尔可以在作品中见到.
![德国增六和弦](/assets/musicnote/ger1.png)

当然,作曲家通常还是通过先现音或延留音来隐藏平行五度,或者通过使用跳进或分解和弦来避免平行五度.
下图中,莫扎特首先通过将E跳进到B(减四度)来避免平行五度,然后在第二个Ger+6,又通过在解决前B到G的分解和弦进行将Ger+6变成It+6
![德国增六和弦](/assets/musicnote/ger2.png)

或者可以通过终止四六和弦来延迟V的到来,也可以解决平行五度.
![德国增六和弦](/assets/musicnote/ger3.png)
我们可以注意到,上图最后一个Ger+6的构成音与其他的不同,虽然他们的音响是相同的(A#=Bb).这是一种当Ger+6进行到I46时常见的等音替代写法,仅用于大调.
这种写法更多是为了眼睛而不是耳朵:A#到还原B看上去比Bb到还原b更加自然,因为我们常常期待升高的音向上进行,降低的音向下进行.

当我们比较Ger+6与V7/N时,也会涉及等音替代问题.
听者可以仅仅凭借和弦的解决来判断某和弦是Ger+6还是属七,而这种变换可以导致某种非常有趣的转调(后面讨论).
如下图第33小节Ger+6听上去很像V7/N(Db7),特别是因为N6出现在它的前面.解决到V7是非常重要的,这使得我们认清它的功能.同样注意#4(B还原3)半音下行到还原4(Bb3)以构成V7的七音.
![德国增六和弦](/assets/musicnote/ger4.png)

Ger+6和弦在字母标记中很常见,他用音阶小六度音上的Mm7和弦来表示.
例如在C大调:Ab7--G7意味着C:Ger+6-V7.爵士理论将Ab7解释为三全音替代,就是说,Ab7和弦是D7和弦(V7/V)的替代.这两个和弦的根音之间为三全音关系,而且这两个和弦使用同一个三全音:在Ab7是C-Gb，在D7是C-F#.

### 常规增六和弦的其他用法
常规增六和弦通常作为一系列和弦中最后的部分导属和弦或终止四六和弦.
然而我们也可以遇到音乐的不同的前后关系中增六和弦的一些用法,它们仍然可以被称作增六和弦.
下面是一些例子:
增六和弦可以作为邻音和弦,用在V-+6-V中,在某种意义上,此时作为属前功能的作用,要弱的多.
更少见的是,其他和弦通常是V/V或vii°/V的某种形式,用在增六和弦与V之间.如下图,vii°7代替了V.
![增六和弦](/assets/musicnote/zlhx.png)
上图的第110-112小节含有一个有趣的,我们曾经讨论过的五度圈模式的变体.
下图a是一个特别简化了的模式,而b则将这个模式作了稍许的细化.
![增六和弦](/assets/musicnote/zlhx1.png)

下图Ger+6正常解决到I46和弦,但是这个I46和弦却是一个经过四六和弦,而不是终止四六和弦.同样注意下例旋律与低音之间的反向.
![增六和弦](/assets/musicnote/zlhx2.png)

### 增六和弦(2)
前面讲了增六和弦的常规情况:作为具有强烈倾向性的属前功能和弦,将(b)6放在低音部,#4放在某个上声部,两个音向外解决到八度的5,它成为V的根音.
增六和弦有时也会以其他的方式运用,包括以下几种情况:
1.增六和弦的其他和弦音作为低音部的音.
2.增六度音程可以由(b)6和#4以外的音构成,从而形成对其他音级而不是5的倾向.
3.增六度音程向外解决于某一和弦的三音和五音,而不是和弦的根音.
4.增六和弦可以不是常见的三种和弦形式.

#### 其他低音位置
增六和弦是一个线性的音响,所以并没有根音.
也许有人将Fr+6看做变化的V7/V,将It+6和Ger+6看做变化的iv7和弦.为此某些理论家用加入限制性标记的罗马数字作为常规标记来表示增六和弦的方法.问题在于,这些和弦其实是没有根音的,他们只有一个最常用的低音位置,那就是将(b)6放在低音部.
虽然小6通常是结构性地作为增六和弦的低音,但其他低音位置也是可能的.此时的声部进行和前面的提到的标准增六和弦的解决时相同或相似的,但增六度音程往往转位为减三度音程.
最常见的变化是将#4放在低音部,如下图:
注意Ger+6的等音写法,用C#代替Db.
![增六和弦其他低音位置](/assets/musicnote/ozlhx.png)

另一个可能的低音位置是将主音放在低音部,如下图:
![增六和弦其他低音位置](/assets/musicnote/ozlhx1.png)

由于增六和弦没有根音,无法标记出转位,因此在分析时不用标记给出和弦的低音位置.只用增六和弦的专属标记就可以了,不用考虑低音是那个音.

#### 解决到其他音级
任何增六和弦中,最重要的无疑是增六度.由于这个音程通常是用来修饰5的.然而特别是在浪漫乐派时期,增六度有时用来强调的音不是5.
在这种情况下我们不得不使用下图的方法来使得这种方法来使得这种关系更加清晰.
![增六和弦解决到其他音级](/assets/musicnote/ozlhx2.png)
在音乐的前后关系中构成辨识这种变化了的增六和弦,我们必须对增六度音程非常熟悉.
在下图中,我们把已经熟悉了的修饰5的增六和弦+6/5移位,用以对照修饰1的增六和弦.
![增六和弦解决到其他音级](/assets/musicnote/ozlhx3.png)

下图中的Ger+6/1-I的终止是这首歌曲的最后结束部分,紧跟在前面几小节传统的V34-I终止的后面.
![增六和弦解决到其他音级](/assets/musicnote/ozlhx4.png)

当增六和弦解决到某一个不是V的和弦时,这个和弦常常是一个副属和弦.
在这种情况下,较好的方法是将分析结果与被该副属和弦倾向的临时主和弦联系起来.
如下图的第44小可以被分析为It+6/6,但更容易理解的方法是将其看做离调到f小调的一个组成部分.
![增六和弦解决到其他音级](/assets/musicnote/ozlhx5.png)

#### 解决到其他和弦音
到目前为止,我们讨论的增六和弦的增六度(或减三度)都是解决到下一个和弦的根音(有使用终止四六和弦修饰).极少数的情况下,增六和弦的增六度或减三度可以解决到和弦的三音或五音,如下图的a和b.
增六和弦的这种用法在音响上与我们讨论过的常规解决有很大的差异.为了表示这种差异,我们将和弦标记放到括号中.
此外,由于增六度或减三度音程表现出更倾向于修饰其他的音而不是5,所以如下图a,我们可以用Ger+6/3的标记来表示.
特别重要的是,要认识到下图b和c是没有共同点的,尽管二者中Ger+6和弦的构成音是相同的,而且后面都跟随了主三和弦.下图b中的主三和弦是相对稳定的三六和弦,而下图c中的主三和弦是终止四六和弦,代表了其后面的原位属和弦.
![增六和弦解决到其他和弦音](/assets/musicnote/ozlhx6.png)

下图是一个Ger+6解决于I和弦五音的例子,从织体的简缩谱可以看出声部进行非常平稳.
![增六和弦解决到其他和弦音](/assets/musicnote/ozlhx7.png)
![增六和弦解决到其他和弦音](/assets/musicnote/ozlhx8.png)

下图的和声进行与上图很相似,但是声部却没那么平稳.
注意增六度音程并没有按照常规向外解决到八度的Ab,本来是可以这样解决的.
![增六和弦解决到其他和弦音](/assets/musicnote/ozlhx9.png)

增六和弦的这种情况有时也可以用于流行音乐.如果用C-E-G-A#重新构建下图的C7和弦,我们就可以将其理解为Ger+6和弦
![增六和弦解决到其他和弦音](/assets/musicnote/ozlhx10.png)
这样我们就可以理解为什么在I-I-IV7-I进行中的"蓝音"(b3布鲁斯特性音)在大调式12小节布鲁斯的前4小节经常可以被发现的原因.

#### 其他类型的增六和弦
在音乐中,遇到除了上述以外的非标准增六和弦的机会会很少,当确实遇到时,仅用+6这个标记就足以表示出这个和弦的特性音程了.
下图就是这样的一种和弦.这里的+6音响很像Fr+6但是只有当Db成为还原D时才可能成立.我们将+6放到括号中是因为增六度音程向外解决到I6和弦的三音.
![其他类型的增六和弦](/assets/musicnote/ozlhx11.png)

+6标记还可以用在一个比较常见的现象中--两个或三个不同的增六音响短暂地放在同一个增六度音程之上.如下图:三种增六和弦的音都出现在了第15小节之中.在这种情况下,也许用+6来标记是最好的方法,虽然也可以用时值最长的Ger+6或用最后出现的It+6来标记.
![其他类型的增六和弦](/assets/musicnote/ozlhx12.png)

## 等音转换与等和弦转调
### 等音转换
作曲家采用等音的原因之一是为了明确地表示出某一个音的进行趋向.
如下图a,当vii°7/V进行到终止I46时,Ab不得不向上进行到A还原.如果将Ab以等音记写成G#,这个进行看上去就会更自然些,如下图b.而在任何固定音高的乐器上,这两个音响在听觉上是完全相同的.这种等音记谱在视觉上是将建立在b音上的减七和弦转别为g#音上的减七和弦,但是并没有对听觉,和弦功能造成任何影响.
当然如果vii°7/V直接解决到V,如下图c,保持Ab的记谱就不会有任何问题,因为七音直接下行到G.
![等音转换](/assets/musicnote/dyzh.png)

如等音记谱一样,作曲家有时还将整个调做等音转换,即等音调记谱.
在下图中,有一个从Bb大调转向Gb大调(bVI级调)的转调,然后又通过调式交替转入gb小调.为了避免这个复杂的调(调号九个降号),舒伯特将其改成了f#小调.
![等音调转换](/assets/musicnote/dydzh.png)

### 等和弦功能转换
在调性音乐中,有四种和弦可以在不同的调上(不是Gb和F#之间的等音调)做出功能的转换,而且当这些和弦解决时,听者可以明显地听出这种功能的转换.

第一种和弦是大小七和弦,它既可以作为V7和弦,也可以作为Ger+6和弦,如下图a.另一种是减七和弦,他的任何一个音都可以成为某调的导音,如下图b.另外两种情况是增三和弦和Fr+6和弦,但它们在等和弦功能转换中极少使用.
下图显示的调性可以用其同主音大调或同主音小调代替.
![等和弦功能转换](/assets/musicnote/dhxfc.png)
等和弦功能转换意味着,当听者听到一个大小七和弦或减七和弦音响时,它们必然会产生一种期待(比如:这个和弦将作为Db大调的V7被解决)而当偶尔听到完全不同的但又合乎逻辑的等和弦功能转换(例如:那个和弦成了c小调的Ger+6)时,也会产生满足感.这样的效果,在作品中经常被用在特殊的戏剧性位置上,被称作等和弦转调.

### 通过大小七和弦的等和弦转调
等和弦转调是指:在转调过程中,两调的共同和弦通过等和弦功能转换而成为第二个调的和弦.
在转调中,该和弦用什么方法记谱并不重要--它可以用第一个调的音记也可以用第二个调,甚至在她出现不止一次时,还可以分别用两个调的音记谱.最重要的是,这个共同和弦在前后两个调上听上去是合理的.

下图的第四个黑线听上去应该是G大调的V7/IV,应该解决于IV,正如其上方谱表中的进行.
然而,这个这个和弦也可以通过等和弦功能转换而成为B大调的Ger+6,正如下方谱表所示.
这种功能和弦转换形成了从G大调向B大调的等和弦转调.
 ![通过大小七和弦的等和弦转调](/assets/musicnote/dsszd.png)

下图的第41小节最后的一个和弦听上去是一个G7和弦.因为这个点上的调性为G大调,听者往往会期待下一小节应该以C和弦(G大调的IV)开始.
但不同的是,这个G7和弦被记成了B大调的Ger+6.请注意,我们没有把第41小节开始的第一个和弦分析为共同和弦(G:I=B:bVI),这是因为第42小节的第一个和弦是终止四六和弦而不是V7/IV=Ger+6,这意味着转调是在这里发生的.
务必记住,共同和弦的确认要从标志着转调的位置向前一个和弦.
 ![通过大小七和弦的等和弦转调](/assets/musicnote/dsszd1.png)


任何前调的属七和弦或副属七和弦都可以通过功能转换称为新调的Ger+6和弦.同样,前调的Ger+6和弦也可以称为新调的属七和弦或副属七和弦.
在应用中,作为共同和弦,大多数情况都是将Ger+6和弦放在新调上,也许是因为这一进行更具有戏剧性.
一般来说,进行功能转换的大小七和弦最常用的是V7/IV.V7/IV称为Ger+6这种常见的关系,如上两张图所示.
It+6和弦也可以等和弦转换成不完全的V7,但由于重复音问题,较少使用.

### 通过减七和弦的等和弦转调
用减七和弦的等和弦转调并不如通过大小七和弦的等和弦转调用的多,尽管任何一个减七和弦都可以导向四个不同的解决方向,而大小七和弦只有两个解决方向.如上上上张图.

下图的第一行乐谱是同一个减七和弦的四种不同解决.第二行还是这个减七和弦,只是先进行到V7再解决到主和弦.
这两种方法:vii°7-I和vii°7-V7-I,在等和弦转调中是常见的.
 ![通过减七和弦的等和弦转调](/assets/musicnote/dsszd2.png)

下图开始的乐章开始于f小调然后转入Ab大调.因为作曲家要重复整个呈示部,他必须在重复之前回到f小调.
海顿在46到47小节通过用G°7和弦(Ab大调vii°7)为转调做好了准备,如上图中的a.
然后在第一"房子"中,他用了同一个音响,却记写成了f小调的vii°56,并且按照上图第二行的b解决.使得音乐回到了将要反复的f小调.
在这里小提琴的C4通过使减七和弦进入f小调的V34而标示出转调的发生.
 ![通过减七和弦的等和弦转调](/assets/musicnote/dsszd3.png)

 下图的开始和结束都在A大调.第140小节出现了一个C#°7和弦,但听者往往会将其听为A#°7和弦,他是A大调的vii°56/ii(也可以理解为vii°7/IV).
 然而贝多芬使这个和弦称为F大调的vii°24,低音部中的c#实际上变成了db.
 当这个和弦再一次在第145小节出现时,他听上去是F大调的vii°7/vi,因为他跟在V的后面,好像要作V-vii°7/vi-vi的阻碍进行,然而再次她又被写成了A#°7和弦,A大调的vii°56/ii.
  ![通过减七和弦的等和弦转调](/assets/musicnote/dsszd4.png)
  ![通过减七和弦的等和弦转调](/assets/musicnote/dsszd5.png)
  ![通过减七和弦的等和弦转调](/assets/musicnote/dsszd6.png)
上图的简缩谱非常值得研究.
140到145小节有一个和声的"偏离",从而使得第139小节的C#音向其目的音D倾向,直到146小节才得以实现.
整个这段音乐是平行乐段.第一乐句长4小节,以第138小节的半终止结束.第二乐句的开始与第一乐句相同,但它通过第140小节到145小节向bVI的离调从4小节扩充到10小节.在简缩谱中这个扩充用括号括出.

### 等和弦转调的其他例子
大小七和弦和减七和弦有时仅在更局部的范围内应用于等和弦转调.
如下图的第160-161小节,有个简短的向ab小调的离调(小那波里和弦!),由于过于简短而很难被认为是转调.第162小节听上去与第160小节的和弦--ab的V7是相同的,但在这里他是G大调的Ger+6.
极少见的小那波里和弦出现在了一个和声模进:G7-c-Eb-ab之中.
  ![等和弦转调的其他例子](/assets/musicnote/odhxzd.png)

## 和声词汇扩展
### 六度代替音属和弦
我们已经熟悉了附加音和弦的概念,例如带有附加六度音的三和弦.这种和弦不是印象主义之前西方音乐和声词汇的标准形式,却很早被认知了.
比如下图第一个和弦是带有附加六度音的IV和弦.我们可能会将其标记为ii56,但是却不能解释未解决的七音,不管我们怎么分析,这都是一个变格终止.
![六度代替音属和弦](/assets/musicnote/lddt.png)
虽然带有附加六度音的三和弦并不是大多数调性音乐的特征,但含有六度代替音的原位属和弦却不少见,特别是在19世纪的音乐中.
这种情况是,根音上方的六度音代替了并不出现的五度音.
下图的三种终止具有相似的效果.
a是一个PAC,b形成了一个用于修饰V和弦五音的规避音.c中A4音代替了五音的位置--这是一个六度代替音.我们会发现这个和弦与iii6和弦含有相同音级,但其功能明显是属和弦.将c的终止分析为iii6-I明显是错误的.
![六度代替音属和弦](/assets/musicnote/lddt1.png)

下图是一个含有五级六度音代替和弦的范例.注意E5这个音,本该是V和弦五音的音,刚好出现在F#5之前.五级六度音代替和弦通常采用这种方式做准备.
这导致某些理论家将其分析为带有非标准规避音的V和弦,两种认识都是可以接受的.
![六度代替音属和弦](/assets/musicnote/lddt2.png)

下图是一个小调的例子,再次注意六度音的预备.
![六度代替音属和弦](/assets/musicnote/lddt3.png)
六度代替音可以出现在原位三和弦之中,如前面的例子所示,也可以与原位V7和弦相结合,如下图a.和弦的七音总是放在六度代替音下方,如下图a.而不放在上方,如图b.
![六度代替音属和弦](/assets/musicnote/lddt4.png)

下图是一个应用六度代替音与原位V7结合的例子.如果在爵士乐中,也许会倾向于将其标记为V13.我们并不认为这是一个真正的十三和弦,因为它缺了太多的和弦构成音(5,9,11音都没有)
![六度代替音属和弦](/assets/musicnote/lddt5.png)
当我们解决一个六度代替音的V或V7时,六度音应下行跳进到主音,即3到1,而且六度音不能作为先现音.

### 升高五音属和弦
如果把V或V7的五音升高半音,我们将得到一个增三和弦(V+)或一个增小七和弦(V+7).
这个变化在大调是很有用的,因为升高的五音成了一个主和弦三音的导音.但如果主三和弦是小三和弦,这个导音的效果就不可能存在存在,因此增属和弦不可能解决于小三和弦.
下图是上方观点的演示,记住V+7中的"+"仅指下方的三和弦,而不包括七音.
![升高五音属和弦](/assets/musicnote/sgwyd.png)
请注意V+7中可能包含一个增六度音程,这主要取决于声部的排列(如上图a的中高音部与次中音部).注意不要将变化的属和弦,无论是转位还是原位,与常规增六和弦混淆.

在大多数实际应用中,增属和弦前面都是用他的自然和弦形式,也就是说,#2也可以被分析为半音经过音,下图的C#5就是一个半音经过音,但同时它也构成了一个由四个八分音符时值组成的V+7.
![升高五音属和弦](/assets/musicnote/sgwyd1.png)

大调的V+和V+7等音与小调的V六度音替代和V7六度音替代.
如下图,但二者的解决方式是完全不一样的,V+升高的五音半音向上进行到3,如下图a.而V六度音替代的六度代替音向下跳进到1,如下图b.
![升高五音属和弦](/assets/musicnote/sgwyd2.png)

下图开始与C#大调的V和弦,而且这个和弦最终解决到I,但被等音记为Db.例子的第二小节,E4音的出现好像构成了一个V7六度替代音,但如果弹奏这个例子,我们会听到这个E4其实是重升D4,
所以和弦应为G#+7.
简缩谱通过将整个例子都记在Db大调上,从而简化这个谱例.
![升高五音属和弦](/assets/musicnote/sgwyd3.png)

副属和弦也可以以增和弦的形式出现.最常用的是V+/IV和V+7/IV,如下图.
![升高五音属和弦](/assets/musicnote/sgwyd4.png)

记住不要将V+和V+7与增六和弦混淆.下图中,V+24/IV的两个外声部构成一个增六度(还原G-E#),所以凭感觉他好像是某种增六和弦,但事实上,图中的分析更为合适.
![升高五音属和弦](/assets/musicnote/sgwyd5.png)

### 九和弦,十一和弦和十三和弦
下图是和弦演示:
![九和弦,十一和弦和十三和弦](/assets/musicnote/jtte.png)

要特别说明的是,只有三和弦和七和弦才是18和19世纪音乐中最基本的和弦材料.
在印象音乐之前,真正的十一和十三和弦几乎没有被用过.九和弦尽管贯穿了整个调性音乐时期,但和弦的九音往往被分析为和弦外音,并且在和弦解决前就消失了.
处理九音最常见的办法就是级进下行构成该和弦的根音重复,如下图,其中小九度音Fb5级进下行到V7根音Eb5.Vb9中的降号表示根音上方的小九度音,而不是真正降低某音.
![九和弦](/assets/musicnote/je.png)

九和弦应用的另一种情况,如下图,从和弦的九音以分解和弦的方式下行到和弦的七音或其他音
![九和弦](/assets/musicnote/je1.png)
当然也可以找到始终保持九和弦结构直到解决的例子,此时和弦的九音级进下行解决,正如解决和弦的七音一样.如下图.
![九和弦](/assets/musicnote/je2.png)
上面所举的例子都是属九和弦.是最常用的九和弦,但偶尔也可以见到其他音级上的九和弦.下图就包含了一个iv9.
![九和弦](/assets/musicnote/je3.png)

九和弦在分析时使用的标记并不标准.最简单的是用罗马数字表示三和弦类型再加上9或b9标记.
九和弦的转位并不像三和七和弦那样普遍.另一方面,九和弦的数字低音记法也过于繁琐.
如果不那么严谨,可以将七和弦转位的数字放在括号之中如:V9(56).这种方法无法标记九和弦的第四转位,但九和弦的第四转位极少用.
下图的2和4小节就应标记为V9(34)和弦.作者在第6小节打断了期待中的V9(34)和弦的属和声音响,而代之以ii和弦(它含有V9和弦五个音中的三个)
![九和弦](/assets/musicnote/je4.png)
![九和弦](/assets/musicnote/je5.png)

### 共同音减七和弦
在调性音乐中,大多数减七和弦都是作为主和弦或其他和弦的导七和弦出现的.虽然减七和弦还因为具有等和弦功能转换的可能性,有时应用等和弦转调中,但也同样是以其解决和弦来决定其功能趋向.
然而还有一种不同常规形式的减七和弦用法.这种方法是,减七和弦进行到一个大三和弦或属七和弦,这个和弦的根音与减七和弦的某个和弦音是同一个音.
下图中,A#°7的七音G5被保留而成为下一个和弦的根音.显然这个减七和弦不是G6或G56的导七和弦.我们把这种减七和弦的用法叫做共同音减七和弦(标记为ct°7).
请特别记住,两和弦的共同音一定是要解决的大三和弦或属七和弦的根音.ct°7和弦可以用任何一种方式来构成,唯一的要求是其中一个音必须与其所修饰的那个和弦的根音为共同音.下图是比较常见的和弦构成--即共同音是该和弦的七音.
![共同音减七和弦](/assets/musicnote/ct.png)

ct°7主要起到是一种装饰和弦的作用,所以我们总是将这个标记放在括号中表示它是一个很弱的和声功能.一个ct°7可以用来装饰任何三和弦或属七和弦,但最常见的是进行到大调的I或大调的V(7)(小调的例子极为少见).
大多数情况下ct°7都表现出明显的非基础性功能的特色,常常作为邻音和弦,如下图的a和b.或经过和弦,如下图的c.请注意所有声部都是平滑进行.
因为ct°7没有理论上的根音,所有在标记时也没有必要标出转位.
![共同音减七和弦](/assets/musicnote/ct1.png)

下图是一个ct°7-I的进行,插入在持续音IV46及其解决和弦I之间.伴奏部分的简缩谱显示出,这里唯一重要的和声事件就是主和弦的呈现.V34只是在弱位由一些邻音组成,而IV46和ct°7则结合起来在内声部构成了一个二重的邻音类型.
![共同音减七和弦](/assets/musicnote/ct2.png)

ct°7通常是完全的,不完全的ct°7有时可以见到,如下图的ct°7和弦省略了一个A.
![共同音减七和弦](/assets/musicnote/ct3.png)

下图的ct°7用来装饰一个属和弦.虽然有ct°7在这里有明显的装饰性,但它们的独特风味在这段音乐以及后面的圆舞曲中同样具有重要作用.
![共同音减七和弦](/assets/musicnote/ct4.png)

下图是一个ct°7装饰V的例子,这是苏萨的著名进行曲中,8小节的引子的基础其实就是一个长的属和声.
![共同音减七和弦](/assets/musicnote/ct5.png)
在记谱上,用以装饰I的ct°7通常被记写成#ii°7,用以装饰V的ct°7通常会被记成#vi°7.

在下图中,作者将装饰I的ct°7写成#iv°7,以明确显示出旋律声部F-Ab-F的分解和弦进行(代替F-G#-F进行).
下图开始主题的一个特点是广泛地用了调式交替,而Ab对这一技术的体现显然比G#更清楚.
![共同音减七和弦](/assets/musicnote/ct6.png)

字母标记有时也用ct°7和弦.如果发现一个减七和弦是非正规解决,而他的某个和弦音与其前面或后面(更长见)和弦根音为同一个音,这个减七和弦就是ct°7和弦.
在下图中Edim7就与其后的Bb和弦根音共用了同一个音.
![共同音减七和弦](/assets/musicnote/ct7.png)

用来装饰主和弦的ct°7很容易与vii°7/V相混淆,因为他们互为等和弦,并且常常用相同的记谱方法,这一现象在上上图表现的很清楚,其中ct°7被记成了vii°34/V(B°7).
记住下面的的区别,就不会在判断上有困难.
![共同音减七和弦](/assets/musicnote/ct8.png)

下图中,作者将第15小节的第二拍和弦记写为D#°7,即I的ct°,但是它却解决到I46-V9,所以实际分析应该为vii°7/V.
![共同音减七和弦](/assets/musicnote/ct9.png)

与用来装饰常见的I和V和弦一样,共同音减七和弦有时也用来装饰副属和弦.
下图第65-66小节所引片段的高潮点上时一个A°7和弦,他可以是第67小节非常短暂出现的I6和弦的ct°7,或是该小节占主要和声地位的V7/ii的ct°7.
![共同音减七和弦](/assets/musicnote/ct10.png)
![共同音减七和弦](/assets/musicnote/ct11.png)

在下图中,ct°7按等和弦关系成了那波里导和弦的一个部分.当我们在第12小节听到这个减七和弦时,我们也许会将其听成vii°7/vi,并且期望其后面是vi和弦,从而形成前面的V7和弦的阻碍解决.其实这个和弦的功能是跟着他后面的V7/N的ct°7.
![共同音减七和弦](/assets/musicnote/ct12.png)

### 和音
有时候,用传统和弦标记(如V，ii等等)来标记一个装饰性和弦是没有实际意义的,所以我们用和音(simultaneity)这个词将其与传统的和弦(chord)加以区分.
这种现象最常见的例子是起经过作用的减七和弦音响.

仔细分析下图的5-8小节.
![和音](/assets/musicnote/sim.png)
这里的基础和声是B大调的I-V7-I,但第6-7小节包含了一个以半音向下滑进的减七和弦系列,在下列用箭头表示:
![和音](/assets/musicnote/sim1.png)
这一系列的减七和弦最好被理解为和音--传统的和弦使用非传统的方法.这里半音下行的音响既不是vii°7也不是ct°7,而是作为连接V7和Vb9的经过和弦。
虽然这些减七和弦也可以被认为是五度圈模进,但我们听到的却不是这样的效果,所以不用罗马数字来分析他们.

下图更复杂一些,这段音乐是在g小调,而且完全是由传统音响组成.和弦外音,如果有的话,非常难确认.
乐谱下标记出了每一个音响的根音,已经可能的两种情况.
![和音](/assets/musicnote/sim2.png)
这个例子中有两个音响在g小调的环境中是没有一样的,他们是第2小节的Bbm和第四小节的Cb4上的It+6.
如果我们将他们看做是充当经过功能的音响结合,那么这个乐句的和声面貌就比较清晰了,下面是分析结果:
![和音](/assets/musicnote/sim3.png)

### 色彩性和弦连续
基础和声进行被修饰的另一种方法是通过使用意外的根音进行到达非本调的和弦.
下图是一个由C大调长达的I-V7-I结束终止组成的,其中到达V7的过程,戏剧性地被意外和弦的色彩性连续所充斥.
这些和弦并没有暗示出任何离调或体现出任何调的传统功能.在分析中,我们只需要标出根音和音响类型就可以了.
![色彩性和弦连续](/assets/musicnote/scc.png)
色彩性和弦连续常常涉及变化中音关系,如上例中C到A和Eb到F#的进行.
或者如下图,第3-4小节的一个更具有"语汇"性的色彩性连续,这一进行可以被分析为V-I-(bIII)-V,放在括号中的bIII表现出其色彩性特征.
![色彩性和弦连续](/assets/musicnote/sim1.png)
比变化中音关系更进一步的是二重变化中音关系.这是指两个和弦分别为不同的调式结构(大和弦/小和弦),根音为大三度或小三度关系,两和弦间没有共同音.如C与ab,c与A等.

下图中的Ab大三和弦和e小三和弦是二重变化中音关系,因为bF与E等音等于大三度关系,而且两个和弦没有共同音,听者可能猜不到这些和弦将导向一个f#小调的正格终止.
![色彩性和弦连续](/assets/musicnote/scc1.png)

## 19世纪晚晚期的调性和声
### 对位法

### 属和声处理
毫无疑问,传统调性系统得以建立的唯一结构"城堡",最适宜的表现形式是V-I进行.
那么一旦这种传统关系被破坏,即使表面上的协和还存在,其结果也必将表现出音乐将脱离历史轨迹.

勃拉姆斯的第四交响曲第四乐章,通过连续变奏的方式来明确其结构。
下图是该曲的基础主主题以及最初呈示时的和声配置:
![属和声处理](/assets/musicnote/shscl.png)
特别值得注意的是,勃拉姆斯在整个过程中通过灵巧的方法避免了任何清晰的属和声应用(注意V7/V-i6的阻碍进行),直到倒数第二个和弦,法国增六和弦解决到一个大主和弦(按照逻辑一个是V/iv,由此构建了第二刺主题的呈示).

在下图中我们可以看到一个大小七和弦的链条,其中每一个和弦都暗示了属功能,却被强行以阻碍方式解决.勃拉姆斯通过音域的移位以及在每一小节交替使用弦乐和木管乐等方式,增强这一简短片段的暧昧氛围.正是这种方法,造成了这段音乐显著的平行运动和几乎无调性的效果.
![属和声处理](/assets/musicnote/shscl1.png)

下面这段音乐中,V7和弦不以和声功能为进行逻辑,而采用色彩性平行进行.并在最后简单但令人满意地到达了Eb大调.
![属和声处理](/assets/musicnote/shscl2.png)

下图基础是Bb大调,音乐中没有涉及真正的和声运动,但却通过了一系列半音阶上行的和声配置给V到I的进行带来了新的活力趣味.如下谱所示,虽然和弦根音的上行运动是严格的平行进行,但大小七和弦的阻碍解决序列却构成了一个紧张的和声动力性模型.
![属和声处理](/assets/musicnote/shscl3.png)

### 模进
前几个例子展示的模进技术,在许多后浪漫主义作曲家的作品中扮演了相当重要的角色,特别实在转调的过程之中.
下图的作者是里姆斯基-科萨科夫,他不但极大地影响了其后的俄罗斯作曲家,而且极大地影响了管弦乐配器技术.这个例子显示出,模进运动已经将非传统的关系合法化了.
![模进](/assets/musicnote/hmj.png)
![模进](/assets/musicnote/hmj1.png)
这段音乐时从作品刚刚开始后进入的,建立在E大调.该选段的开始时C#大三和弦,体现为V/ii.模进从选段的第4小节开始,通过一些列相互为全音关系的离调,从C#到A,最后导向B和弦上的半终止.有意思的是,每一个模进音组的第二个和弦多少有一点增六和弦的因素.这个和弦接着修饰了模进音组的第三个和弦(该和弦给紧跟其后调域的V7)而且这两个和弦还共用同一个三全音.平滑的模进运动表现出连续离调(C#-Eb-F-G-A)的一系列和弦与整体上E大调调性之间构成了微妙的关系.
前面柴科夫斯基的例子是以上行的半音阶配置的一些列被阻碍解决的属七和弦为特色.
传统上,一个色彩性模进的和弦连续常常用于为非功能性的低音线配置和声,被称作欧姆尼巴士,它同样充满了变化音的和弦连续.
![欧姆尼巴士](/assets/musicnote/onmbus.png)
虽然这段音乐也可以在原位V7和V56之间分析出向c小调离调的其他和弦(Ger+6-ii46-Ger+6),但这种通常以很快的速度演奏的音乐片段,还是更倾向于被分析为在低音部和高音部中带有半音经过音的V7和弦.欧姆尼巴士还可以为下行的低音线配和声.如下图
![欧姆尼巴士](/assets/musicnote/omnbus.png)
我们注意到,上图各个时段只有一个声部与低音部形成反向,而且这个声部实在高音部,中音部,次中音部交替出现的.还要注意,图中的每三个和弦中的第一个为小三和弦,而他们爷刚好互为变化中音关系.从转调的角度看,这个模进的组合快速并自然地从一个调转到远关系调,并且保持了最平滑的声部进行.
这种构思可以在下图找到,他发生在一个导向C大调第二主题的过渡段.
![欧姆尼巴士转调](/assets/musicnote/bhzyzd.png)
下图是另外的例子,其中欧姆尼巴士被用来构成从G大调导Db大调的转调.这段音乐开始于Eb大调,并且以原位主和弦开始.
加入的C#音构成了一个德国增六和弦的音响,由此导向了第12小节的G大调(I46).在其后的小节中,我们发现低音部是B音而高音部是D音.当这两个声部逐步向外扩展欧姆尼巴士带我们在第16小节到达一个Db和弦,明确地表示出Db是新的主音.
![欧姆尼巴士转调](/assets/musicnote/omnbuszd.png)
